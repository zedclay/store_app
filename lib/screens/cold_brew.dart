...
import 'package:shop_app/screens/details.dart';
...
class _ColdBrewState extends State<ColdBrew> {
  ...
  Widget build(BuildContext context) {
    return ListView(children: [
      buildListItem(
          'assets/images/coffee4.png', '150', ColorPalette().secoundSlice),
      buildListItem(
          'assets/images/coffee2.png', '200', ColorPalette().firstSlice)
    ]);
  }
